...
Building a portfolio of data analysis projects centered on industrial and engineering datasets — process data, equipment performance, project tracking, and operational KPIs — using Python, Pandas, SQL, and Power BI.
...
**Data Analysis**
`Python` `Pandas` `Jupyter Notebook` `SQL` `Power BI` `Excel` `EDA` `Data Cleaning` `Data Visualization`

**Engineering Background**
`SolidWorks` `Mechanical Design` `GD&T` `Microsoft Project`

**Also exploring**
`Industrial Automation (ICONICS, Ignition SCADA)` `OT / ICS Cybersecurity fundamentals`
